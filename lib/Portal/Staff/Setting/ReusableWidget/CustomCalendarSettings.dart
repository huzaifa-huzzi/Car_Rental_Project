...
class CustomCalendarSettings extends StatefulWidget {
  ...
  @override
  State<CustomCalendarSettings> createState() => _CustomCalendarSettingsState();
}

class _CustomCalendarSettingsState extends State<CustomCalendarSettings> {
