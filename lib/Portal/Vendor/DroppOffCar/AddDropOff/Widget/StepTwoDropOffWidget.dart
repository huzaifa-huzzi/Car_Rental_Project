...
import 'package:car_rental_project/Portal/Vendor/DroppOffCar/ReusableWidgetOfDropoff/CustomButtonDropOff.dart';
import 'package:car_rental_project/Portal/Vendor/DroppOffCar/ReusableWidgetOfDropoff/HeaderWebDropOffWidget.dart';
import 'package:car_rental_project/Portal/Vendor/DroppOffCar/ReusableWidgetOfDropoff/PrimaryBtnDropOff.dart';
                      ...
                      children: [
                        ...
                        if (isHovered)
                          Container(
                            ...
                            child:  Center(
                              child: Image.asset(IconString.zoomIcon,width: 50,height: 50,),
                            ),
                          ),
                        if (!isHovered)
                          Positioned(
                            ...
                            child: GestureDetector(
                              ...
                              child: const CircleAvatar(
                                  ...
                                  child: Icon(Icons.close, color: AppColors.tertiaryTextColor, size: 14)
                              ),
                            ),
                          ),
                      ],
                      ...
                      FittedBox(
                        ...
                        child: Text.rich(
                          TextSpan(
                            ...
                            children: [
                              TextSpan(text: TextString.under10, style: TTextTheme.titleTwelve(context)),
                            ],
                          ),
                        ),
                      ),
