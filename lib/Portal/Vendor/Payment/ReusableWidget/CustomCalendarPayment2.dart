...
class CustomCalendarPayment2 extends StatefulWidget {
  final Function(DateTime) onDateSelected;
  final VoidCallback onCancel;
  final double width;
  final bool allowFuture;

  const CustomCalendarPayment2({
    super.key,
  ...
  @override
  State<CustomCalendarPayment2> createState() => _CustomCalendarPayment2State();
}

class _CustomCalendarPayment2State extends State<CustomCalendarPayment2> {
