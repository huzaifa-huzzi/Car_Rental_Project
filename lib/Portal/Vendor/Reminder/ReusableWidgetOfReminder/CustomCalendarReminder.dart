...
class CustomCalendarReminder extends StatefulWidget {
  final Function(DateTime) onDateSelected;
  final VoidCallback onCancel;
  final double width;

  const CustomCalendarReminder({
    super.key,
  ...
  @override
  State<CustomCalendarReminder> createState() => _CustomCalendarReminderState();
}
class _CustomCalendarReminderState extends State<CustomCalendarReminder> {
