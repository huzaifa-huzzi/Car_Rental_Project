import 'package:car_rental_project/Portal/Vendor/PickupCar/PickUpDetailScreen/Widget/TermAndSignWidget.dart';
import 'package:car_rental_project/Portal/Vendor/PickupCar/PickUpDetailScreen/Widget/VehicleConditionWidget.dart';
...
class PickupDetailWidget extends StatelessWidget {
  ...
  final PickupCarController tabController = Get.find<PickupCarController>();
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          /// TAB CONTENT
          Obx(() => _buildTabContent(context,isMobile)),
        ],
      ),
    );
  }

  //  This Screen Content / Customer and Contract
  Widget _buildCustomerAndContractTab(
