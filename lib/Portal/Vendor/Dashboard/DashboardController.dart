...
class DashboardController extends GetxController {
  ...
  var selectedPeriod = '2026'.obs;
  final List<String> periods = ['2026', '2025', '2024', '2023', '2022'];
  ...
  var selectedPickupPeriod = 'This Year'.obs;
  final List<String> pickupPeriods = ['Last 7 Days', 'Last 30 Days', 'This Year'];
  ...
  final pickupData = {
    ...
    'This Year': {'completed': 0.9, 'awaiting': 0.1, 'overdue': 0.2, 'processing': 0.4},
  }.obs;
  ...
  final List<String> damagePeriods = ['Last 7 Days', 'Last 30 Days', 'This Year'];
  ...
  final damageDataMap = {
    ...
    'This Year': {'safe': 9.0, 'damage': 12.0, 'safeCount': "5,000", 'damageCount': "10,000"},
  }.obs;
