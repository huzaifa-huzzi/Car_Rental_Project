      ...
      child: Row(
        ...
        children: [
          Container(
            ...
            child: Image.asset(iconPath, width: 18, height: 18,color: AppColors.blackColor,),
          ),
        ...
        child: Column(
          ...
          children: [
            ...
            isMobile
                ? Column(
              children: [
                _responsiveInfoItem(context, IconString.userRoleAdmin, "Username", controller.userName.value),
                _responsiveInfoItem(context, IconString.changePasswordIcon, "Password", controller.password.value),
              ],
            )
                : Row(
