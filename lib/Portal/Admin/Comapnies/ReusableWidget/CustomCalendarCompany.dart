...
class CustomCalendarCompany extends StatefulWidget {
  final Function(DateTime) onDateSelected;
  final VoidCallback onCancel;
  final double width;

  const CustomCalendarCompany({
    super.key,
  ...
  @override
  State<CustomCalendarCompany> createState() => _CustomCalendarCompanyState();
}

class _CustomCalendarCompanyState extends State<CustomCalendarCompany> {
