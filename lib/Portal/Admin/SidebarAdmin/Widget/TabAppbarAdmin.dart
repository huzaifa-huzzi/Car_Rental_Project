...
class TabAppBarAdmin extends StatefulWidget implements PreferredSizeWidget {
  ...
  @override
  State<TabAppBarAdmin> createState() => _TabAppBarAdminState();

  @override
  Size get preferredSize => Size.fromHeight(AppSizes.buttonHeight(Get.context!));
}

class _TabAppBarAdminState extends State<TabAppBarAdmin> with WidgetsBindingObserver {
