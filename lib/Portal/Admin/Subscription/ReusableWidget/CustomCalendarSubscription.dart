...
class CustomCalendarSubscription extends StatefulWidget {
  final Function(DateTime) onDateSelected;
  final VoidCallback onCancel;
  final double width;

  const CustomCalendarSubscription({
    super.key,
  ...
  @override
  State<CustomCalendarSubscription> createState() => _CustomCalendarSubscriptionState();
}

class _CustomCalendarSubscriptionState extends State<CustomCalendarSubscription> {
          ...
          Flexible(
            child: GridView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                bool isSelected = _selectedDay != null && _selectedDay == currentCellDate;
