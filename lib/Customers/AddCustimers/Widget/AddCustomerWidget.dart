  ...
  Widget _cardTab(BuildContext context, String label, bool isSelected) {
    return Container(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          Icon(Icons.credit_card, size: 20, color: isSelected ? AppColors.availableBackgroundColor : AppColors.quadrantalTextColor),
          const SizedBox(height: 8),
          Text(
            label,
            style: TextStyle(
              color: isSelected ? AppColors.availableBackgroundColor : Colors.black87,
                    ...
                    suffixIcon: isCreditCard ? Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          Image.asset(IconString.masterCardIcon, width: 25),
                        ],
                      ),
                    ) : null,
